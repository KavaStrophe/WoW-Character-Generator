...
import { NightElfeFemaleFirstNamePartsOne, NightElfeFemaleFirstNamePartsTwo, NightElfeLastNameParts, NightElfeMaleFirstNamePartsOne, NightElfeMaleFirstNamePartsTwo } from 'Resources/Lists/Names/NightElfNameParts';

export class GenerateNightElfNameQueryHandler implements IGenerateNameQueryHandler {
    ...
    GetLastName():string {
        const lastNameGenerator = new TwoPartNameGeneratorHelper(NightElfeLastNameParts);
    ...
    GetFirstName(query: GenerateNameQuery):string{
        ...
        switch(query.gender){
            case CharacterGender.Female:
                firstNameParts = GetRandomElementOfArray([NightElfeFemaleFirstNamePartsOne, NightElfeFemaleFirstNamePartsTwo]);
                break;
            case CharacterGender.Male:
                firstNameParts = GetRandomElementOfArray([NightElfeMaleFirstNamePartsOne, NightElfeMaleFirstNamePartsTwo]);
                break;
            default:
